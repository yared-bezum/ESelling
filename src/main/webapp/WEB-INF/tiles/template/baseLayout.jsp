	...
	<div class="container">
		<div id="header">
			<div class="right"
				...
				<ul>
					<li class="right"><a href="?lang=sp"> <img align="right"
							alt="Spanish" src="resources/images/Sp.png"
							style="margin-right: -20px" title="हिंदी" class="drop5">
					</a></li>
					<li class="right"><a href="?lang=fr"> <img align="right"
							alt="French" src="resources/images/Fr.png"
							style="margin-right: 6px" title="አማርኛ" class="drop5">
					</a></li>
					<li class="right"><a href="?lang=en"> <img align="right"
				...
				<div class="menu">
					<ul>
						<li><a href="<spring:url value="/login" />"><spring:message
									code="baseLayout.login" /></a></li>


						<li><a href=""><pre id="separator">   |   </pre></a></li>

						<li><a href="<spring:url value="/VendorSignUp" />"><spring:message
									code="baseLayout.vendor" /></a></li>
						<li><a href="#"><pre id="separator">   |   </pre></a></li>

						<li><a href="<spring:url value="/CustomerSignUp" />"><spring:message
									code="baseLayout.customer" /></a></li>
					</ul>
					<br style="clear: left" />
				</div>
